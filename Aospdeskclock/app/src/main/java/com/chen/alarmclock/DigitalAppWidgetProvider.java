...
import com.chen.deskclock.data.City;
import com.chen.deskclock.data.DataModel;
import com.chen.deskclock.uidata.UiDataModel;
import com.chen.deskclock.worldclock.CitySelectionActivity;
...
import static com.chen.deskclock.alarms.AlarmStateManager.ACTION_ALARM_CHANGED;
import static com.chen.deskclock.data.DataModel.ACTION_WORLD_CITIES_CHANGED;
...
public class DigitalAppWidgetProvider extends AppWidgetProvider {
     ...
     */
    private static final String ACTION_ON_DAY_CHANGE = "com.chen.deskclock.ON_DAY_CHANGE";
    ...
    private void updateDayChangeCallback(Context context) {
        ...
        final PendingIntent pi =
                PendingIntent.getBroadcast(context, 0, DAY_CHANGE_INTENT,
                        Utils.pendingIntentFlags(FLAG_UPDATE_CURRENT));
    ...
    private void removeDayChangeCallback(Context context) {
        final PendingIntent pi =
                PendingIntent.getBroadcast(context, 0, DAY_CHANGE_INTENT,
                        Utils.pendingIntentFlags(FLAG_NO_CREATE));
        if (pi != null) {
