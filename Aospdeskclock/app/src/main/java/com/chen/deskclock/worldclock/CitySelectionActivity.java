...
package com.chen.deskclock.worldclock;
...
import com.chen.deskclock.actionbarmenu.MenuItemController;
...
import com.chen.deskclock.actionbarmenu.SearchMenuItemController;
...
public final class CitySelectionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Allow each row to take focus so pressing OK/center on a focused city toggles it.
        mCitiesList.setItemsCanFocus(true);
