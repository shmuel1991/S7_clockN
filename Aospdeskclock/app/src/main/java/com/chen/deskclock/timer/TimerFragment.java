...
import com.chen.deskclock.DeskClockFragment;
...
import com.chen.deskclock.data.TimerListener;
import com.chen.deskclock.data.TimerStringFormatter;
...
public final class TimerFragment extends DeskClockFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "com.chen.deskclock.action.TIMER_SETUP";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Pressing the OK/Enter hardware key while entering a duration starts the timer.
        mCreateTimerView.setStartTimerAction(this::createAndStartTimerFromSetup);
    ...
    public void onFabClick(@NonNull ImageView fab) {
        if (mCurrentView == mTimersView) {
            ...
            createAndStartTimerFromSetup();
        }
    }

    /**
     * Creates and starts a timer from the duration entered in {@link #mCreateTimerView}, then
     * returns to the list of timers. Invoked from the fab and from the OK/Enter hardware key.
     */
    private void createAndStartTimerFromSetup() {
        mCreatingTimer = true;
        try {
    ...
    private void showCreateTimerView(int updateTypes) {
        ...
        // Take focus so the duration can be entered with the device's hardware keys.
        mCreateTimerView.requestFocus();
