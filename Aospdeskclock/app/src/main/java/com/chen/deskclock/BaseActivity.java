...
import static com.chen.deskclock.AnimatorUtils.ARGB_EVALUATOR;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adjustAppColor(resolveWindowColor(), false /* animate */);
    }
    ...
    /**
     * @return the dynamic (Material You) background color on Android 12+, otherwise the
     *         baseline Material 3 window background resolved from the theme.
     */
    @ColorInt
    private int resolveWindowColor() {
        if (DynamicColors.isAvailable()) {
            return DynamicColors.getBackgroundColor(this);
        }
        return ThemeUtils.resolveColor(this, android.R.attr.windowBackground);
    }
