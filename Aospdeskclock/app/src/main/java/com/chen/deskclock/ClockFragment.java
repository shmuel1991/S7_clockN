...
import com.chen.deskclock.data.CityListener;
...
import static com.chen.deskclock.uidata.UiDataModel.Tab.CLOCKS;
...
public final class ClockFragment extends DeskClockFragment {
    ...
    public void onResume() {
        ...
        if (mAlarmChangeReceiver != null) {
            ...
            Utils.registerReceiver(activity, mAlarmChangeReceiver, filter);
        }
